...
- Pydantic (label: good first issue) <br> Pydantic é uma biblioteca para validação de dados e definição de configurações com Python, utilizando tipagem para facilitar a construção de APIs robustas.
